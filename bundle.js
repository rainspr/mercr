...
riot.tag2('rfgen', '<section> <h3>勧誘カードジェネレータ(仮)</h3> <form ref="formref" onsubmit="return false;"> <div class="row"> <div class="col-md-6"> <div class="form-group"> <label>名前</label> <input class="form-control" type="text"> </div> <div class="form-group"> <label>希望期間</label> <input class="form-control" type="text"> </div> <div class="form-group"> <label>希望レート</label> <input class="form-control" type="text"> </div> <div class="form-group"> <label>参加イベント</label> <div class="form-inline"> <label> <input type="checkbox"> ギルバト </label> <label> <input type="checkbox"> レアメ </label> <label> <input type="checkbox"> 暴走/爆走 </label> <label> <input type="checkbox"> 降臨 </label> </div> </div> <div class="form-group"> <label>ギルログ参加</label> <div class="form-inline"> <label> <input type="checkbox"> 参加 </label> <label> <input type="checkbox"> 連絡・挨拶のみ </label> <label> <input type="checkbox"> 無言 </label> </div> </div> <div class="form-group"> <label>その他補足事項等</label> <textarea class="form-control" rows="4"></textarea> </div> </div> <div class="col-md-6"> <div class="form-group"> <label>参加率</label> <div class="form-inline"> <label> <input type="checkbox"> 朝 </label> <label> <input type="checkbox"> 昼 </label> <label> <input type="checkbox"> 夕 </label> <label> <input type="checkbox"> 夜 </label> </div> <div class="form-inline"> <label>備考(貯水・周回など)</label> <input class="form-control" type="text"> </div> </div> <div class="form-group"> <label>突破力</label> <textarea class="form-control" rows="3"></textarea> </div> <div class="form-group"> <label>コンテ</label> <div class="form-inline"> <label> <input type="checkbox"> 不可 </label> <label> <input type="checkbox"> 勇気の水のみ </label> <label> <input type="checkbox"> ダイヤ </label> </div> </div> <div class="form-group"> <label>祈り</label> <input class="form-control" type="text"> </div> <div class="form-group"> <label>所持パーティ</label> <div class="form-inline"> <label> <input type="checkbox"> 属性BCパ </label> <label> <input type="checkbox"> 弓BCパ </label> <label> <input type="checkbox"> 魔BCパ </label> <label> <input type="checkbox"> 銃BCパ </label> </div> <div class="form-inline"> <label> <input type="checkbox"> 弓フィクセパ </label> <label> <input type="checkbox"> 魔フィクセパ </label> <label> <input type="checkbox"> 銃フィクセパ </label> </div> <div class="form-inline"> <label>詳細(☆5中衛打撃の有無等)</label> <input class="form-control" type="text"> </div> <div class="form-inline"> <label> <input type="checkbox"> ソサパ </label> </div> <div class="form-inline"> <label> <input type="checkbox"> リトラクトパ </label> </div> <div class="form-inline"> <label> <input type="checkbox"> 救援エグザント </label> <label> <input type="checkbox"> 救援リトラクト </label> <label> <input type="checkbox"> 救援ソーサリー </label> <label> <input type="checkbox"> 救援リバイヴ </label> </div> <div class="form-inline"> <label>その他:</label> <input class="form-control" type="text"> </div> </div> </div> </div> <button class="btn btn-default">作成</button> </form> </section>', '', '', function(opts) {
});